...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int, gaussian_dim : int = 3, time_duration: list = [-0.5, 0.5], rot_4d: bool = False, force_sh_3d: bool = False, sh_degree_t : int = 0):
        ...
        # Inside __init__ method, after existing initializations
    ...
    def capture(self):
        ...
        # Replace the existing capture method's return for gaussian_dim == 4
...
# gaussians.restore(model_params, None)
    ...
    @property
    def get_static_max_radii2D(self):
        return self.static_max_radii2D
