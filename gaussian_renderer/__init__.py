...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None):
    ...
    raster_settings = GaussianRasterizationSettings(
        ...
        prefiltered=False,
        opa_threshold=pipe.opa_threshold, # opacity threshold
        debug=pipe.debug
    )
    ...
    # static info from pc(point clouds) 
    ...
    rendered_image, radii, depth, alpha, flow, covs_com, radii_static, color_4d, color_3d, invdepth = rasterizer(
        ...
        # --- from here static attributes ---
        means3D_static = means3D_static,     # static
        means2D_static = means2D_static,     # static
        shs_static = sh_static,              # static
        opacities_static = opacity_static,   # static
        scales_static = scales_static,       # static
        rotations_static = rotations_static) # static
